                ...
                <aside id="sidebar-wrapper">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="nav-item <?= (service('uri')->getSegment(2) === 'home') ? 'active' : ''?>">
                            <a href="<?= base_url('pegawai/home')?>" class="nav-link"><i
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="nav-link" href="<?=base_url('pegawai/daftar-barang')?>">Data Barang</a>
                                </li>
                                <li><a class="nav-link" href="<?= base_url('pegawai/barang-masuk')?>">Data Barang
                                        Masuk</a></li>
                                <li><a class="nav-link" href="<?= base_url('pegawai/barang-keluar')?>">Data Barang
                                        Keluar</a></li>
                            </ul>
                        </li>
                        <li class="menu-header">Transaksi</li>
                        <li
                            class="nav-item dropdown <?=(service('uri')->getSegment(2) === 'transaksi')? 'active' : '' ?>">
                            <a href="#" class="nav-link has-dropdown " data-toggle="dropdown"><i
                                    class="fas fa-print"></i> <span>Data Transaksi</span></a>
                            <ul class="dropdown-menu">
                                <li><a class="nav-link" href="<?= base_url('pegawai/transaksi')?>">Transaksi</a>
                                </li>
                                <li><a class="nav-link" href="<?= base_url('pegawai/pesan-barang')?>">Pesan Barang</a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="nav-item dropdown">
                            <a href="#" class="nav-link has-dropdown " data-toggle="dropdown"><i
                                    class="fas fa-print"></i> <span>Laporan Barang</span></a>
                            <ul class="dropdown-menu">
                                <li><a class="nav-link" href="<?= base_url('pegawai/laporan-masuk')?>">Laporan Barang
                                        Masuk</a></li>
                                <li><a class="nav-link" href="<?= base_url('pegawai/laporan-keluar')?>">Laporan Barang
                                        Keluar</a></li>
                        ...
                        <li class="nav-item <?= (service('uri')->getSegment(2) === 'supplier') ? 'active' : ''?>">
                            <a href="<?= base_url('pegawai/supplier')?>" class="nav-link"><i class="fas fa-print"></i>
