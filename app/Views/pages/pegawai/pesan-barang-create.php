            ...
            $('#id_barang').on('change', function(){
                ...
                $.ajax({
                    ...
                    success: function(response){
                        ...
                        biayapembelian.textContent = "Biaya pembelian: Rp. " + (minOrder * unitCost).toLocaleString();

                        let biayapersediaan = document.getElementById("biayapersediaan");
                        biayapersediaan.textContent = "Biaya persediaan untuk periode berikutnya: Rp. " + (minOrder * unitCost * holdingCost).toLocaleString();

                        let biayapemesanan = document.getElementById("biayapemesanan");
                        biayapemesanan.textContent = "Biaya pemesanan per unit barang: Rp. " + orderCostPerUnit.toLocaleString();

                        let totalbiaya = document.getElementById("totalbiaya");
                        totalbiaya.textContent = "Total biaya untuk periode ini dan berikutnya: Rp. " + totalCost.toLocaleString();
                    }
                });
            });
        });
