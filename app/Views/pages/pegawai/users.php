                    ...
                    <table class="table table-stripped" id="table-1">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td><?= $user['role']?></td>
                          <td>
                            <a href="<?= base_url('pegawai/users/edit/').$user['id']?>" class="btn btn-primary">Edit</a>
                            <button data-target="#hapusModal<?=$user['id']?>" data-toggle="modal" class="btn btn-danger">Hapus</button>
                          </td>
                        </tr>
                      </tbody> 
                      <?php endforeach?> 
