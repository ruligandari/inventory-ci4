...
<!-- Modal -->
<?php foreach ($laporanMasuk as $laporan) :?>
<div class="modal fade" id="hapusModal<?=$laporan['id_barang_masuk']?>" tabindex="-1" role="dialog"
...
function setAction(action) {
    ...
    if (action === "cetak") {
        form.action = "<?= base_url('pegawai/laporan-masuk/create') ?>";
    } else if (action === "unduh") {
        form.action = "<?= base_url('pegawai/laporan-masuk/unduh') ?>";
    }
}
</script>
<?= $this->endSection()?>